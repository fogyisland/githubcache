...
export default async function RepoNotFound(): Promise<ReactElement> {
  const t = await getTranslations('repo.notFound');
  return (
    <main className="mx-auto max-w-2xl px-4 py-20 text-center">
      <div className="ghc-fade-up">
        ...
        <h1 className="ghc-display-name mt-6">{t('title')}</h1>
